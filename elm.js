...
var $author$project$Main$viewGriddedImage = function (model) {
	...
	if (((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) && (_v0.c.$ === 'Just')) {
		...
		var width = _v0.b.a;
		var height = _v0.c.a;
		var cellWidth = width / model.gridSize;
		var verticalLines = A2(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$stroke(model.gridColor),
			...
			A2($elm$core$List$range, 0, model.gridSize));
		var cellHeight = height / model.gridSize;
...
var $author$project$Main$viewPixelFrog = function (model) {
	return A2(
		$elm$svg$Svg$svg,
		_List_fromArray(
			[
				...
				$elm$svg$Svg$Attributes$class('pixelated')
			]),
		model.downloadSuccess ? _List_fromArray(
			[
				A2(
				$elm$svg$Svg$rect,
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill('#00aa00')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$rect,
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill('#00cc00')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$rect,
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$fill('#007700')
					]),
				_List_Nil),
				A2(
				$elm$svg$Svg$rect,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$viewPixelFrog(model)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
